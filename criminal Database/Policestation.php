...
<body>
  ...
  <div class="adhar1">
    ...
    <div class="title">Search Criminal Details by Policestation</div>
    <div class="content">
      <form action="policetationprint.php" method="post">

        <div class="user-details">
          <div class="input-box">
            <span class="details">Enter Here Policestation </span>
            <input type="text" placeholder="Enter Policestation" name="Policestation" required>
          </div>
          <input type="submit" class="btn" value="Search" name="Search criminal by Policestation">
        </div>
      </form>
    </div>
  </div>
