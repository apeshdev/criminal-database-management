...
<body>
  ...
  <div class="adhar1">
    ...
    <div class="content">
      <form action="crimeprint.php" method="post">

        <div class="user-details">
          <div class="input-box">
            <span class="details">By Crime</span>
            <input type="text" placeholder="Enter Crime" name="Crime" required>
</div>
            <input type="submit" class="btn" value="Search" name="Serach criminal data">
</div>  </form>
    </div>
  </div>
  </div>
